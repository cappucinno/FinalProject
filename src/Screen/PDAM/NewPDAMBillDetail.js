...
import {PDAMCreatePaymentAction} from './redux/action';
            ...
            <View style={styles.Containerisi}>
              <View style={styles.ContainerTextBillDetail1}>
                ...
                <View
                  ...
                  <Text style={styles.TextDataRes}>{DetailRes?.usage}</Text>
                </View>
              </View>
              <View style={styles.ContainerTextBillDetail2}>
                ...
                <View style={styles.ContainerTextData}>
                  ...
                  <Text
                    style={styles.TextDataRes}>{`Rp ${DetailRes?.admin}`}</Text>
                </View>
                <View style={styles.ContainerTextData}>
                  <Text
